...
export default function Product() {
	...
	const handleChangePage = async (currentPage, currentSize) => {
		const product = productTotal.slice(
								...
								<div className='list__filter'>
									<div className='list__filter-sort'>
										...
										<Select
											...
											<Option value='date'>
												{t('products.Date, new to old')}
											</Option>
										</Select>
									</div>
									<div className='list__filter-result'>
										<span>{`${productTotal.length} ${t(
											'products.found',
										)}`}</span>
									</div>
