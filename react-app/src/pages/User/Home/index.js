			...
			<div className='container'>
				...
				<section className='home__product'>
					<div className='container product__container'>
						<Tabs defaultActiveKey='1'>
							<TabPane
								tab={<button className='button button-round button-transparent'>{t('home.product.Special Product')}</button>}
								key='1'>
								<Slide data={productHome.special} type='product' xl={4} lg={4} md={3} sm={2} xs={2}></Slide>
							</TabPane>
							<TabPane
								tab={<button className='button button-round button-transparent'>{t('home.product.New Product')}</button>}
								key='2'>
								<Slide data={productHome.new} type='product' xl={4} lg={4} md={3} sm={2} xs={2}></Slide>
							</TabPane>
							<TabPane tab={<button className='button button-round button-transparent'>{t('home.product.Bestseller')}</button>} key='3'>
								<Slide data={productHome.sale} type='product' xl={4} lg={4} md={3} sm={2} xs={2}></Slide>
							</TabPane>
						</Tabs>
					</div>
				</section>
				...
				<section className='home__countdown'>
					<div
						...
						style={{
							backgroundImage: "url('https://cdn.shopify.com/s/files/1/0412/8151/9765/files/dealbanner-min.jpg?v=1593257102')",
						}}>
